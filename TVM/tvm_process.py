...
import time
import schedule
from tvm_utils import scraper, data_cleaning, epu_data
import warnings
warnings.filterwarnings('ignore')

# Function to Outline the Process to collect Data from TVM
def tvm_process():
...
# Function to Regularly Execute TVM Process on the First Day of Every Month
def schedule_monthly():
    if datetime.now().day == 1:
        tvm_process()

# Schedule Process
schedule.every().day.at("08:00").do(schedule_monthly) 
